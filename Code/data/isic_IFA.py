...
class DatasetISICIFA(Dataset):
    ...
    def load_frame(self, query_name, support_names):
        ...
        query_sam = self.get_data_and_mask(os.path.join(self.base_path, 'ISIC-SAM-Mask', 'train', 'sam_mask_vit_b_t50_p32_s50', query_id))
        support_sams =[self.get_data_and_mask(os.path.join(self.base_path, 'ISIC-SAM-Mask', 'train', 'sam_mask_vit_b_t50_p32_s50'
                                                            ,supp_id))
